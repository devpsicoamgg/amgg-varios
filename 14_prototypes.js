...
function Persona(nombre, edad) {
  ...
  // Ej. 
  function DatosBasicosUsuarios(nombre, documento, fechaNacimiento, diagnosticoInicial, tipoDeDiagnostico) {
...
DatosBasicosUsuarios.prototype.obtenerTipoDeIntervencion = function () { 
    console.log('Pcte ' + this.nombre + ' con tipo de dx ' + this.tipoDeDiagnostico);
};

// Método para mostrar los datos básicos del paciente
DatosBasicosUsuarios.prototype.datosBasicosPcte = function () { 
    console.log('Pcte ' + this.nombre + ' con doc ' + this.documento + ', nacimiento ' + this.fechaNacimiento + ' y tipo de dx ' + this.tipoDeDiagnostico);
};

function Paciente(nombre, documento, fechaNacimiento, diagnosticoInicial, tipoDeDiagnostico, fechaValoracion, diagnosticoConfirmado) {
    // Llamada al constructor del prototipo padre (DatosBasicosUsuarios)
    DatosBasicosUsuarios.call(this, nombre, documento, fechaNacimiento, diagnosticoInicial, tipoDeDiagnostico);
...
const cam83sua = new Paciente('Alberto Guerrero', 'CC 78987567', '17/10/1983', 'F412 - Mixto Ansiedad & Depresion', 'Impresion Diagnostica', '25/07/2023', 'Confirmado');
const edwaSpider = new Paciente('Otilia Granados', 'CC 1078654890', '17/10/2009', 'Problemas relacionados con circunstancias psicosociales', 'Impresion Diagnostica', '25/07/2023', 'En proceso');
